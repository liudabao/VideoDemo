...
import com.example.administrator.videotest.service.DownloadService;
import com.example.administrator.videotest.util.DataManager;
...
public class SetFragment extends Fragment {
	...
	private void initEvent(){
		...
		about.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				DialogUtil.showDialog(getActivity(),"熊猫的尾巴@copy right 2016" );
			}
		});
	}
